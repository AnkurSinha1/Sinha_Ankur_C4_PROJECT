...
1> Ankur Sinha (Group Facilitator)

We are sharing the roles Module wise:

Evaluation Rubrics for Header:

1> Ankur Sinha : Worked on Login , Logout functionality , CSS and Logo and Worked  on CSS and Logo

Evaluation Rubrics for Home Page:

1> Ankur Sinha : Worked on filtering released movies and released movie list, Worked on Creating Upcoming Movies heading, Movies Cards and rendering upcoming.

Evaluation Rubrics for Details Page:

1> Ankur Sinha : Worked on Rating section and Artist Cards and rendering the Movie details ,Worked on Poster Part of the movie and trailer video rendering.
